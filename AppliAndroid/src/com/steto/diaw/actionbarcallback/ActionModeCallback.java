...
public class ActionModeCallback implements ActionMode.Callback {
	...
	public ActionModeCallback(Activity activity, AbstractSelectableItemListAdapter adapter, OnRenameClickListener renameClickListener, OnDeleteClickListener deleteClickListener) {
